...
for level, areas in questions.items():
    for area, qs in tqdm(areas.items()):
        ...
        for question in qs:
            prompt = f"""Please identify key concepts in the following question. Each concept should be a noun. Provide the concepts in a list, separated by commas, without bullet points.
